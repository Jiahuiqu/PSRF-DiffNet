    ...
    def train(self, epoch, verbose):
        ...
        for i in range(epoch):
            ...
            if (i + 1) % verbose == 0:
                ...
                plt.savefig('./img/LRHS_Elastic1000/Result_test' + str(i) + '.jpg')
                plt.show()
                plt.close()
...
if __name__ == "__main__":
    ...
    train_loader = DataLoader(train_datasat, batch_size=8, shuffle=True, num_workers=0, drop_last=False)
    ...
    sr3 = SR3(device, img_size=img_size, LR_size=LR_size, loss_type='l1',
              ...
              save_path='./model/LRHS_Elastic1000/',
              load_path='./model/LRHS_Elastic1000/SR3_model_epoch-1099.pt', load=False,
              inner_channel=64,
